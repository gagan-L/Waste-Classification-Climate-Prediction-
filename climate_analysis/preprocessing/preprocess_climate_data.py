...
def preprocess_climate_data():
    ...
    file_path = 'climate_analysis/dataset/climate_data.csv'
    ...
    os.makedirs('climate_analysis/results', exist_ok=True)
    output_file = 'climate_analysis/results/preprocessed_climate_data.csv'
